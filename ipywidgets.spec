...
Version  : 7.6.4
Release  : 59
URL      : https://files.pythonhosted.org/packages/f1/d9/4b5729f6e2876a8a61be2b00b04fce18c15d807d4360a4b70496a5b20fe9/ipywidgets-7.6.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/f1/d9/4b5729f6e2876a8a61be2b00b04fce18c15d807d4360a4b70496a5b20fe9/ipywidgets-7.6.4.tar.gz
...
%prep
%setup -q -n ipywidgets-7.6.4
cd %{_builddir}/ipywidgets-7.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630625715
...
cp %{_builddir}/ipywidgets-7.6.4/LICENSE %{buildroot}/usr/share/package-licenses/ipywidgets/5dc7e0ef3878c3d4a92a7233208e6f91553de266
